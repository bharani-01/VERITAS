...
/** User-only profile page at /user/profile — not shared with admin. */
    ...
    <main className="admin-main profile-main">
      <header className="admin-header">
        <div>
          ...
          <h1>My profile</h1>
          <p>Update how you appear across VERITAS.</p>
        </div>
      </header>
          ...
          <div className="profile-form-grid three-col">
            <div className="field">
              ...
              <input
                ...
                key={`user-name-${user.id}-${user.display_name}`}
                autoComplete="name"
              />
            </div>
            <div className="field">
              ...
              <input
                ...
                key={`user-user-${user.id}-${user.username}`}
            ...
            <div className="field">
              ...
              <input id="user_email" name="email" type="email" value={user.email} disabled />
