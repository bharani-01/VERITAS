...
3. [docs/architecture.md](docs/architecture.md) — package layout and request flow
4. [docs/design.md](docs/design.md) — UI system and frontend boundaries
5. [docs/security.md](docs/security.md) — auth, sessions, and hard constraints
6. [docs/agents/overview.md](docs/agents/overview.md) — which agent persona to use

## Non-negotiables

- Phase 1 = identity and user management; Phase 2 = projects, stub scans, Connect GitHub (no real vuln engines).
